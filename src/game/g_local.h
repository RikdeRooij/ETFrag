...
typedef struct {
    ...
    int				characterIndex;		// codePRK had no use really, always -1
...
//int		G_CharacterIndex( const char *name ); // codePRK not used anymore
...
extern vmCvar_t	g_adminsysDir;
extern vmCvar_t	g_adminsysPrefix;

extern vmCvar_t	g_kickTime;

extern vmCvar_t	g_airstrikeRestoreValue;

extern vmCvar_t g_noFallDamage;

extern vmCvar_t	g_turrets;

#ifdef GS_DEBUG
extern vmCvar_t g_testVar;
#endif
...
// codePRK g_realism flags
//#define REAL_JUMP_STAMINA	1 // is in bg_public.h
#define REAL_SLOW_REGEN		2	// slower health regeneration
#define REAL_NO_UNILOSE		4	// never lose uni
#define REAL_HEALTH_SPEED	8	// walk slower at low health
#define REAL_USE_HITLOC		16	// dmg based on were target was hit
#define REAL_USE_ALTDIST	32	// dmg over distance reduced faster and earlier
#define REAL_USE_BFALL		64	// bullet falloff

// #define COMBAT_USE_CCBONUS 4  close combat dmg bonus
// #define COMBAT_USE_IRUPG 16  rifles +acc
...
qboolean G_tryObjDrop( gentity_t *ent, qboolean knifeonly );
