...
void G_WriteClientSessionData( gclient_t *client, qboolean restart )
{
	...
	s = va("%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %f %f %i %i %i %i %i %i %i %i %i %i %i %i %s %s %u %s %i %i %i %i",
...
#ifdef GS_UUID // !!!!!!
		//client->sess.uuid,
		client->sess.uuid && (*client->sess.uuid) ? client->sess.uuid : "NOUUID",
#endif
...
void G_ReadSessionData( gclient_t *client )
{
	...
	sscanf( s, "%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %f %f %i %i %i %i %i %i %i %i %i %i %i %i %s %s %u %s %i %i %i %i", //mcwf GeoIP
...
//	sess->experience = 0;
	...
	// get uuid here...
#ifdef GS_UUID
	client->pers.allow_uuid = qtrue;
	trap_SendServerCommand( client - level.clients, "req_uuid" );
#endif
